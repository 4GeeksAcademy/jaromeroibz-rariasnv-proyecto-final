...
Revision ID: b37aae544e90
Revises: 
Create Date: 2023-11-18 01:59:27.543579
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('evaluating_proposal', 'task_done', 'task_not_done', name='petitionerstatus'), nullable=False),
    sa.Column('petitioner_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['petitioner_id'], ['petitioner.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    ...
    sa.Column('status', sa.Enum('pending_approval', 'accepted', 'insuficient', 'done', name='offererstatus'), nullable=False),
